...
public class SQLQueries {
    public static final String SQL_INIT =
                    ...
                    "    user_id     INT  NOT NULL, " +
                    "    activity_id INT  NOT NULL, " +
                    "    append_time TIME NOT NULL, " +
                    "    comment     VARCHAR(250), " +
                    "    CONSTRAINT fk_users_update_requests_users_id " +
                    "        FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE, " +
                    "    CONSTRAINT fk_users_update_requests_activities_id " +
                    "        FOREIGN KEY (activity_id) REFERENCES activities (id) ON DELETE CASCADE ON UPDATE CASCADE );" +
    ...
    public static final String SQL_DROP =
            "DROP TABLE IF EXISTS admin_comments; " +
                    ...
                    "DROP TABLE IF EXISTS users_append_time_activity_requests; " +
                    "DROP TABLE IF EXISTS users_delete_activity_requests; " +
                    "DROP TABLE IF EXISTS users_create_activity_requests; " +
                    "DROP TABLE IF EXISTS activity_stories;" +
