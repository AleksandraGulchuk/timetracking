    ...
    <tr>
        ...
        <td>
            <table class="table table-striped table-hover">
                <thead>
                <tr>
                    <td><a href="controller?command=sortBy&listName=activities&condition=id" class="link-dark"><b>ID</b></a>
                    </td>
                    <td><a href="controller?command=sortBy&listName=activities&condition=category" class="link-dark"><b><fmt:message
                            key="category"/></b></a></td>
                    <td><a href="controller?command=sortBy&listName=activities&condition=title"
                           class="link-dark"><b><fmt:message key="title"/> </b></a></td>
                    <td><a href="controller?command=sortBy&listName=activities&condition=description" class="link-dark"><b><fmt:message
                            key="description"/></b></a></td>
                    ...
                    <td><a href="controller?command=sortBy&listName=activities&condition=status"
                           class="link-dark"><b><fmt:message key="status"/></b></a></td>
                    <td><b></b></td>
                </tr>
                </thead>
                <tbody>
                        ...
                        <td>
                            <form action="controller" method="get">
                                ...
                                <input type="submit" class="btn btn-secondary my-2 my-sm-0"
                                       value="<fmt:message key="button.go"/>">
